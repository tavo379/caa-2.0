...
import { LayoutDashboard, Users, FileText, LogOut, Settings, BarChart3, FolderKanban, Calculator } from 'lucide-react'
...
export function Sidebar({ userEmail }: SidebarProps) {
    ...
    const navItems = [
        ...
        { href: '/proyectos', label: es.projects.title, icon: FolderKanban },
        { href: '/cotizaciones', label: es.quotes.title, icon: Calculator },
